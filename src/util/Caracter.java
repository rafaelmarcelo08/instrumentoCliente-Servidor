...
public class Caracter {
	...
	private final String MASK_ALPHANUMERRIC= "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
	...
	public String getMASK_ALPHANUMERRIC() {
		return MASK_ALPHANUMERRIC;
	}
}
